...
class Highlight(BaseModel):
    ...
    content: str = Field(
        description="The highlight content - what happened or was decided"
    )
    
    category: HighlightCategory = Field(
        default=HighlightCategory.GENERAL,
        description="Category of the highlight"
    )
    
    importance: HighlightImportance = Field(
        default=HighlightImportance.MEDIUM,
        description="How important this highlight is"
    )
    ...
    context: Optional[str] = Field(
        default=None,
        description="Additional context about the highlight"
    )
