...
class TestCrossProjectFunctionality:
    ...
    def temp_config(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            config = TuskConfig(storage_mode="global", data_dir=Path(temp_dir) / "tusk_data")
    ...
    def test_cross_project_search_no_filter(self, storage_and_search):
        ...
        results = search_engine.search_cross_project(query="*", limit=50)  # Get everything
    ...
    def test_cross_project_search_with_project_filter(self, storage_and_search):
        ...
        # Create test data for multiple projects
        projects_data = [("project-a", "/path/to/project-a"), ("project-b", "/path/to/project-b")]
    ...
    def test_cross_project_search_with_date_filter(self, storage_and_search):
        ...
        results = search_engine.search_cross_project(query="*", days_back=7, limit=50)
    ...
    def test_cross_project_search_performance(self, storage_and_search):
        ...
        results = search_engine.search_cross_project(query="Checkpoint", limit=100)
    ...
    def test_project_registry_functionality(self, temp_config):
        ...
        registry = {"/path/to/project-a": "project-a", "/path/to/project-b": "project-b"}
