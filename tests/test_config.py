...
class TestTuskConfig:
    ...
    def test_config_from_env_defaults(self):
        ...
        with patch.dict(os.environ, {}, clear=False):
            ...
            env_keys_to_clear = [
                "TUSK_SERVER_NAME", "TUSK_DATA_DIR", "TUSK_SEARCH_ENABLED",
                "TUSK_MAX_SEARCH_RESULTS", "TUSK_DEFAULT_TTL", "TUSK_MAX_HIGHLIGHTS",
                "TUSK_TRANSFORMATIONS", "TUSK_LOG_LEVEL", "TUSK_LOG_DIR"
            ]
    ...
    def test_config_integer_env_parsing(self):
        ...
        with patch.dict(os.environ, {
            "TUSK_MAX_SEARCH_RESULTS": "75",
            "TUSK_MAX_HIGHLIGHTS": "15"
        }):
            config = TuskConfig.from_env()
